    ...
    const renderItemSizes = ({ item, index }: any) => (
        <TouchableOpacity
            ...
            <Text style={[
                ...
                styles.sizeItemText]}>{item.label}</Text>
        </TouchableOpacity>
    )
    ...
    const loop = () => {
        ...
        for (let index = 1; index <= length; index++) {
            ratingViewList.push(
                <View key={index}>
                    <Image
                        style={[styles.sellerRatingImage, {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.detailSectionContainer}>
                    ...
                    <View style={styles.deliveryTimeView}>
                        <Image
                            style={styles.deliveryTimeImage}
                            source={icons.clock}
                        />
                    ...
                    <View style={styles.sellerInfoContainer}>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <View style={styles.profileDetails}>
                                <Text style={styles.profileNameText}>{dummyData.myProfile.name}</Text>
                                <Text style={styles.profileAddressText}>12 KM away from you</Text>
                            </View>
                        </View>
            ...
            <View style={styles.footerSection}>
                ...
                <View style={{ alignSelf: 'flex-end', flexDirection: 'row', flex: 1, justifyContent: 'space-between' }}>
